...
def process_ipa(ipa_path):
    ...
    if len(parse.errors) == 0:
        checker = IntegrityCheck(parse.to_check_params())
        result = checker.to_result()
        check_results['warning'] = result['warning'] or ''
        check_results['error'] = result['error'] or ''

    return check_results


if __name__ == '__main__':
    process_ipa('/Users/mikejing191/Desktop/SmartPay_Example-IPA/SmartPay_Example-v1.4.1-b20190703142838.ipa')
    sys.exit(0)
